...
[Playwright](https://github.com/microsoft/playwright) ⭐ 82,667 | 🐛 595 | 🌐 TypeScript | 📅 2026-02-14 is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API. Available for Node.js, Python, .NET and Java.
...
* [artillery-engine-playwright](https://github.com/artilleryio/artillery/tree/main/packages/artillery-engine-playwright) ⭐ 8,893 | 🐛 479 | 🌐 JavaScript | 📅 2026-02-15 - Load testing with Playwright.
* [CodeceptJS](https://github.com/Codeception/CodeceptJS) ⭐ 4,218 | 🐛 212 | 🌐 JavaScript | 📅 2026-02-15 - Supercharged End 2 End Testing Framework for Node.js.
...
* [playwright-bdd](https://github.com/vitalets/playwright-bdd) ⭐ 610 | 🐛 48 | 🌐 TypeScript | 📅 2026-02-13 - BDD testing with Playwright runner and CucumberJS.
...
* [playwright-python](https://github.com/microsoft/playwright-python) ⭐ 14,258 | 🐛 72 | 🌐 Python | 📅 2026-02-11 - Official Playwright port to Python.
* [playwright-go](https://github.com/playwright-community/playwright-go) ⭐ 3,195 | 🐛 74 | 🌐 Go | 📅 2026-01-16 - Playwright port for Golang.
...
* [testomatio-reporter](https://github.com/testomatio/reporter) ⭐ 145 | 🐛 28 | 🌐 JavaScript | 📅 2026-02-15 - Runs and sends test executions to the TCMS testomatio, Jira / Linear / Azure DevOps task management.
...
* [VS Code](https://github.com/microsoft/vscode) ⭐ 181,725 | 🐛 13,936 | 🌐 TypeScript | 📅 2026-02-16 - Playwright is used to run cross-browser tests on their web builds.
* [TypeScript](https://github.com/microsoft/TypeScript) ⭐ 107,836 | 🐛 5,456 | 🌐 TypeScript | 📅 2026-02-16 - Playwright is used test TypeScript.js across browsers.
* [xterm.js](https://github.com/xtermjs/xterm.js) ⭐ 19,925 | 🐛 122 | 🌐 TypeScript | 📅 2026-02-16 - Playwright is used to run cross-browser integration tests.
